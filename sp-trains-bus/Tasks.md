...
- [x] **1.1** Create folder structure following hexagonal architecture
- [x] **1.2** Define Domain entities (Stop, Arrival, Route, Trip, MetroLine, Location)
- [x] **1.3** Create Domain protocols (TransitRepositoryProtocol, LocationServiceProtocol, StorageServiceProtocol)
- [x] **1.4** Setup dependency injection container (AppDependencies)
- [x] **1.5** Configure Info.plist for location permissions and network security

### Phase 2: Infrastructure Layer - Network
> Priority: Critical | Estimated: 2-3 days

- [x] **2.1** Implement APIClient with async/await
  - Base URL configuration
  - Request building
  - Response parsing
  - Error handling
- [x] **2.2** Define APIEndpoint enum with all endpoints
  ...
  - stop(stopId)
  - routes()
- [x] **2.3** Create DTO models matching API responses
- [x] **2.4** Implement DTOMappers to convert DTOs to Domain entities
- [x] **2.5** Implement TransitAPIRepository conforming to TransitRepositoryProtocol
- [x] **2.6** Add unit tests for network layer

### Phase 3: Infrastructure Layer - Services
> Priority: Critical | Estimated: 1-2 days

- [x] **3.1** Implement CoreLocationService
  - Request location permissions
  - Get current location
  - Monitor location updates
  - Handle authorization status changes
- [x] **3.2** Implement UserDefaultsStorageService
  - Save/load favorite stops
  - Save/load home/work locations
  - Save/load user preferences
- [x] **3.3** Add unit tests for services

### Phase 4: Application Layer - Use Cases
> Priority: High | Estimated: 1-2 days

- [x] **4.1** Implement GetNearbyStopsUseCase
- [x] **4.2** Implement GetArrivalsUseCase
- [x] **4.3** Implement SearchStopsUseCase
- [x] **4.4** Implement GetTripRouteUseCase
- [x] **4.5** Implement GetRouteShapeUseCase
- [x] **4.6** Implement GetMetroStatusUseCase (mock data initially)

### Phase 5: UI Foundation & Design System
> Priority: High | Estimated: 2-3 days

- [x] **5.1** Define color palette (AppColors)
  - Primary, secondary, accent colors
  - Metro line colors (L1-Azul, L2-Verde, etc.)
  - Status colors (normal, warning, alert)
- [x] **5.2** Define typography (AppFonts)
- [x] **5.3** Create GlassCard component (glassmorphism effect)
- [x] **5.4** Create RouteBadge component (colored bus/metro badges)
- [x] **5.5** Create CountdownTimer component (animated countdown)
- [x] **5.6** Create LoadingView and ErrorView components
- [x] **5.7** Create common View extensions

### Phase 6: Home Screen
> Priority: High | Estimated: 2-3 days

- [x] **6.1** Implement HomeViewModel
  - Load user's current location
  - Load nearby stops
  - Load favorite stops
  - Time-based greeting logic
- [x] **6.2** Create GreetingHeader component
  - Dynamic greeting (Good Morning/Afternoon/Evening)
  - User name display
- [x] **6.3** Create QuickCommuteCard component
  - To Work / To Home buttons
  - ETA display
- [x] **6.4** Create MiniMapView component
  - Show user location
  - Show nearby stops
- [x] **6.5** Create FavoritesSection with FavoriteStopCard
  - Horizontal scrolling list
  - Next arrival preview
- [x] **6.6** Assemble HomeView with all components

### Phase 7: Stop Detail Screen
> Priority: High | Estimated: 2-3 days

- [x] **7.1** Implement StopDetailViewModel
  - Load stop information
  - Load arrivals with auto-refresh
  - Timer countdown logic
- [x] **7.2** Create NextBusCard component
  - Large countdown display
  - Route badge
  - Destination headsign
- [x] **7.3** Create BusProgressIndicator component
  - Visual progress toward arrival
- [x] **7.4** Create UpcomingBusList component
  - List of next buses
  - Color-coded by route
  - Tap to see trip details
- [x] **7.5** Assemble StopDetailView
- [x] **7.6** Add pull-to-refresh functionality

### Phase 8: System Status Screen (Metro/Train)
> Priority: Medium | Estimated: 1-2 days

- [x] **8.1** Implement SystemStatusViewModel
  - Load metro line statuses
  - Overall system health calculation
- [x] **8.2** Create OverallStatusCard component
  - Status indicator (Normal/Alert)
  - Animated pulse effect
- [x] **8.3** Create MetroLineCard component
  - Line color and name
  - Current status
  - Status description
- [x] **8.4** Assemble SystemStatusView
  - Grid layout for metro lines

### Phase 9: Map Explorer Screen
> Priority: Medium | Estimated: 3-4 days

- [x] **9.1** Implement MapExplorerViewModel
  - Handle map region changes
  - Load stops in visible region
  - Filter by transport type
  - Route shape loading
- [x] **9.2** Create TransitMapView using MapKit
  - Custom map style
  - User location display
- [x] **9.3** Create StopAnnotation component
  - Custom marker design
  - Callout with stop info
- [x] **9.4** Create FilterChips component
  - Bus / Metro / Train filters
  - Selected state styling
- [x] **9.5** Create RouteOverlay for displaying trip shapes
- [x] **9.6** Assemble MapExplorerView
- [x] **9.7** Add "Plan Route" functionality (future enhancement)

### Phase 10: Search Screen
> Priority: Medium | Estimated: 1-2 days

- [x] **10.1** Implement SearchViewModel
  - Debounced search
  - Recent searches
  - Search results
- [x] **10.2** Create SearchResultRow component
  - Stop name and description
  - Distance (if available)
  - Route badges
- [x] **10.3** Assemble SearchView
  - Search bar
...
- [x] **11.1** Create MainTabView with 5 tabs
  - Home (house icon)
  - Nearby (location icon)
  - Search (magnifying glass)
  - Status (signal icon)
  - Map (map icon)
- [x] **11.2** Implement navigation between screens
- [x] **11.3** Handle deep linking (future)

### Phase 12: Polish & Enhancements
> Priority: Low | Estimated: 2-3 days

- [x] **12.1** Add haptic feedback for interactions
- [x] **12.2** Add animations and transitions
- [x] **12.3** Implement dark mode support
- [x] **12.4** Add skeleton loading states
- [x] **12.5** Implement offline mode / caching
- [x] **12.6** Add accessibility support (VoiceOver, Dynamic Type)
- [x] **12.7** Localization (Portuguese/English)

### Phase 13: Testing & Quality
> Priority: High | Estimated: 2-3 days

- [x] **13.1** Unit tests for Domain layer
- [x] **13.2** Unit tests for Use Cases
- [x] **13.3** Unit tests for ViewModels
- [x] **13.4** UI tests for critical flows
